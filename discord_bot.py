...
class BlockBrainBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        from engagement_commands import setup as setup_engagement_commands
        await setup_engagement_commands(self)
    ...
    def is_personal_profile(self, account, extra_text: str = ""):
        ...
        weak_project_indicators = [
            "building", "solana", "ether", "eth", "web3", ".art", ".xyz",
            ".com", "pfp", "collection", "game", "neural", "gpu",
            "prediction", "velcor3",
        ]
        crypto_context_terms = [
            "crypto", "web3", "blockchain", "onchain", "solana", "ethereum", "eth",
            "defi", "nft", "token", "coin", "protocol", "dex", "liquidity", "airdrop",
        ]
